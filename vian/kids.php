...
$women=$db->select('SELECT * FROM `products` WHERE type_id=3');
...
<section id="product1"id="heroo">
    <div class="pro-container">
        ...
        ?>
        <div class="pro">
           <img src="<?php echo 'img/'.$women[$i]['image'] ?>" alt="">
            <div class="description">
                <span><?php for($j=0;$j<count($manufacturer);$j++)
                {
                    if($manufacturer[$j]['id']==$women[$i]['manufacturer_id'])
                        echo $manufacturer[$j]['name'];
                }

                ?></span>
                <h5><?php echo $women[$i]['name'] ?></h5>
                <div class="star">
