...
<div class="container customer-login" >
  <div class="row">
    <div style="margin-left: 25%;" class="col-sm-5 col-sm-offset-4">
      <h2 style="text-align: center;color: rgb(93, 93, 95);">Customer Register</h2>
      <form action="/customer_register" method="POST">
        ...
        <div class="mb-3">
            <input type="text" name="bank_card_code" class="form-control" id="bank_card_code" placeholder="bank card code">
        </div>
